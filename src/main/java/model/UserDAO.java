...
public class UserDAO {
	...
	// SOCIAL-001 : 소셜 로그인(구글/라인) 회원 저장. 비밀번호 없이 PROVIDER/PROVIDER_ID로 구분한다.
	public void insertSocialUser(UserDTO dto) {
		...
		String sql = "INSERT INTO " + TABLE
				+ " (USER_ID, PASSWORD, NICKNAME, EMAIL, PROVIDER, PROVIDER_ID, REG_DATE) VALUES (?, NULL, ?, ?, ?, ?, SYSDATE)";
		...
		try {
			...
			pstmt.setString(4, dto.getProvider());
			pstmt.setString(5, dto.getProviderId());
